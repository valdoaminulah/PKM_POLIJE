...
if (!$id) {
    // Jika tidak ada ID, arahkan kembali ke daftar dosen
...
try {
    ...
    // Pastikan path folder 'upload' sesuai dengan lokasi file ini
    $pathFisik = dirname(__DIR__) . DIRECTORY_SEPARATOR . "upload" . DIRECTORY_SEPARATOR . $namaFoto;
    $urlFoto = "../upload/" . $namaFoto;

    // Jika file fisik tidak ada atau database kosong, gunakan UI Avatars
...
<body class="font-sans antialiased bg-gray-50 text-slate-900">
    ...
    <section class="w-full min-h-screen py-10 md:py-16 px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- Tombol Kembali -->
            <div class="mb-8">
                <a href="informasi_dosen.php" class="inline-flex items-center gap-3 px-5 py-2.5 bg-white text-blue-900 hover:bg-blue-900 hover:text-white transition-all duration-300 rounded-xl shadow-sm border border-gray-200 group">
